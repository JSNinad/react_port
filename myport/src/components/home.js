...
I have a passion for <span className="text-color">technology</span>and enjoy working on <span className="text-color">innovative projects.</span> My skills
            include web development, programming, videography , and writing. I believe in the power of creativity to
            solve problems and make the world a better place. 
        </p>
        <p className="text-lg ml-4 mb-4 md:w-1/2 ">
            Feel free to explore my portfolio and get in touch if you have any questions or if
